...
<!-- 						<div id="timePic1" class="timePic" data-rsvttime="1">예약가능</div> -->
<!-- 						<div id="timePic2" class="timePic" data-rsvttime="2">예약가능</div> -->
<!-- 						<div id="timePic3" class="timePic" data-rsvttime="3">예약가능</div> -->
<!-- 						<div id="timePic4" class="timePic" data-rsvttime="4">예약가능</div> -->
<!-- 						<div id="timePic5" class="timePic" data-rsvttime="5">예약가능</div> -->
<!-- 						<div id="timePic6" class="timePic" data-rsvttime="6">예약가능<div></div></div> -->
<!-- 						<div class="timePic-disabled" data-rsvttime="" style="height: 188px;">점심시간</div> -->
<!-- 						<div id="timePic7" class="timePic" data-rsvttime="7">예약가능</div> -->
<!-- 						<div id="timePic8" class="timePic" data-rsvttime="8">예약가능</div> -->
<!-- 						<div id="timePic9" class="timePic" data-rsvttime="9">예약가능</div> -->
<!-- 						<div id="timePic10" class="timePic" data-rsvttime="10">예약가능</div> -->
<!-- 						<div id="timePic11" class="timePic" data-rsvttime="11">예약가능</div> -->
<!-- 						<div id="timePic12" class="timePic" data-rsvttime="12">예약가능</div> -->
<!-- 						<div id="timePic13" class="timePic" data-rsvttime="13">예약가능</div> -->
<!-- 						<div id="timePic14" class="timePic" data-rsvttime="14">예약가능</div> -->
<!-- 						<div id="timePic15" class="timePic" data-rsvttime="15">예약가능</div> -->
<!-- 						<div id="timePic16" class="timePic" data-rsvttime="16">예약가능</div> -->
					</div>
				...
				<div class="patient-info-right" id="reservBtnArea" style="width: 130px; justify-content: space-between;">
					<div class="patient-info-right">
						<div class="form-check-reception">
							<span>
								<input type="radio" id="male" name="paSex" class="form-check-input" disabled/>
								<label for="male">남성</label>
							</span>
							<span>
								<input type="radio" id="female" name="paSex" class="form-check-input" disabled/>
...
$(document).ready(function() {
	$('.aside-ams-reserv').find('svg').find('path').attr('fill', '#0ABAB5');
	
	 $('.aside-ams-reserv').find('.dduk-nav-menu').css('color', '#0ABAB5'); 
	 
	 $('.dduk-nav-li').mouseleave(
				function()	{
					 $('.aside-ams-reserv').find('svg').find('path').attr('fill', '#0ABAB5');
					 $(this).find('#aside-ams-reserv-text').attr('style', 'color: #0ABAB5;');
				}	
			);
...
document.addEventListener('DOMContentLoaded', function() {
	...
	// 달력 DB 로딩
	function createCalendarList(empNo) {
...
// 		 createCalendarList(empNo);
	 ...
	 function highlightAvailableTimes(dbStartTime, dbEndTime) {
	   ...
	   timeDivs.forEach((timePic, index) => {
	     ...
	     if (index !== firstInRangeIndex && index !== lastInRangeIndex) {
	       ...
	       if (isTimeInRange(startTime, endTime, dbStartTime, dbEndTime)) {
	         timePic.style.backgroundColor = 'transparent';
	         timePic.innerHTML = ' ';
	       }
	     }
	   });
	...
	$(document).on("click",".fc-day", function(){
		...
		let clinicTable = `
			<div id="timePic1" class="timePic" data-strtime="09:00" data-endtime="09:30" data-rsvttime="1">예약가능</div>
			<div id="timePic2" class="timePic" data-strtime="09:30" data-endtime="10:00" data-rsvttime="2">예약가능</div>
			<div id="timePic3" class="timePic" data-strtime="10:00" data-endtime="10:30" data-rsvttime="3">예약가능</div>
			<div id="timePic4" class="timePic" data-strtime="10:30" data-endtime="11:00" data-rsvttime="4">예약가능</div>
			<div id="timePic5" class="timePic" data-strtime="11:00" data-endtime="11:30" data-rsvttime="5">예약가능</div>
			<div id="timePic6" class="timePic" data-strtime="11:30" data-endtime="12:00" data-rsvttime="6">예약가능<div></div></div>
			<div class="timePic-disabled" data-rsvttime="" style="height: 188px;">점심시간</div>
			<div id="timePic7" class="timePic" data-strtime="13:00" data-endtime="13:30" data-rsvttime="7">예약가능</div>
			<div id="timePic8" class="timePic" data-strtime="13:30" data-endtime="14:00" data-rsvttime="8">예약가능</div>
			<div id="timePic9" class="timePic" data-strtime="14:00" data-endtime="14:30" data-rsvttime="9">예약가능</div>
			<div id="timePic10" class="timePic" data-strtime="14:30" data-endtime="15:00" data-rsvttime="10">예약가능</div>
			<div id="timePic11" class="timePic" data-strtime="15:00" data-endtime="15:30" data-rsvttime="11">예약가능</div>
			<div id="timePic12" class="timePic" data-strtime="15:30" data-endtime="16:00" data-rsvttime="12">예약가능</div>
			<div id="timePic13" class="timePic" data-strtime="16:00" data-endtime="16:30" data-rsvttime="13">예약가능</div>
			<div id="timePic14" class="timePic" data-strtime="16:30" data-endtime="17:00" data-rsvttime="14">예약가능</div>
			<div id="timePic15" class="timePic" data-strtime="17:00" data-endtime="17:30" data-rsvttime="15">예약가능</div>
			<div id="timePic16" class="timePic" data-strtime="17:30" data-endtime="18:00"  data-rsvttime="16">예약가능</div>
		`;
...
function searchPatientByNo(paNo){
	$.ajax({
		...
		success: function(rst){
			...
			let reservBtn = `
				<button class="dduk-btn-active" id="createReservationBtn" type="button" 
				style="position: relative; width: 100px;">예약</button>
			`
			//예약버튼 생성
			$('#reservBtnAreaBtn').html("");
			$('#reservBtnAreaBtn').append(reservBtn);
...
$(document).on("click", ".abled", function() {
	...
	let reservDsEndTime = $('#reservDsEndTime').attr('value');
	
	let [year, month, day] = rsvtDt.split('-');
	let [hours, minutes] = reservDsEndTime.split(':');
...
$(document).on('click', '#createReservationBtn', function(){
	let rsvtDt = $('#reservRsvtDt').val();
	console.log("rsvtDt!!!!!!----",rsvtDt);
...
$(document).on("click", "#createReservationSubmitBtn", function(){
	...
	$.ajax({
		...
		success: function(rst){
			...
			if(rsvtTime=='1') {
						...
						$('#timePic1').css('background-color','#FFECEC');
						$('#timePic1').html("");
						$('#timePic1').append("<div>9:00-9:30</div><div class='picPaName'>" + paName + "</div>");
					} else if(rsvtTime=='2') {
						$('#timePic2').removeClass("abled");
						$('#timePic2').css('background-color','#FFECEC');
						$('#timePic2').html("");
						$('#timePic2').append("<div>9:30-10:00</div><div class='picPaName'>" + paName + "</div>");
					} else if(rsvtTime=='3') {
						$('#timePic3').removeClass("abled");
						$('#timePic3').css('background-color','#FFECEC');
						$('#timePic3').html("");
						$('#timePic3').append("<div>10:00-10:30</div><div class='picPaName'>" + paName + "</div>");
					} else if(rsvtTime=='4') {
						$('#timePic4').removeClass("abled");
						$('#timePic4').css('background-color','#FFECEC');
						$('#timePic4').html("");
						$('#timePic4').append("<div>10:30-11:00</div><div class='picPaName'>" + paName + "</div>");
					} else if(rsvtTime=='5') {
						$('#timePic5').removeClass("abled");
						$('#timePic5').css('background-color','#FFECEC');
						$('#timePic5').html("");
						$('#timePic5').append("<div>11:00-11:30</div><div class='picPaName'>" + paName + "</div>");
					} else if(rsvtTime=='6') {
						$('#timePic6').removeClass("abled");
						$('#timePic6').css('background-color','#FFECEC');
						$('#timePic6').html("");
						$('#timePic6').append("<div>11:30-12:00<div><div class='picPaName'>" + paName + "</div>");
					} else if(rsvtTime=='7') {
						$('#timePic7').removeClass("abled");
						$('#timePic7').css('background-color','#FFECEC');
						$('#timePic7').html("");
						$('#timePic7').append("<div>13:00-13:30</div><div class='picPaName'>" + paName + "</div>");
					} else if(rsvtTime=='8') {
						$('#timePic8').removeClass("abled");
						$('#timePic8').css('background-color','#FFECEC');
						$('#timePic8').html("");
						$('#timePic8').append("<div>13:30-14:00</div><div class='picPaName'>" + paName + "</div>");
					} else if(rsvtTime=='9') {
						$('#timePic9').removeClass("abled");
						$('#timePic9').css('background-color','#FFECEC');
						$('#timePic9').html("");
						$('#timePic9').append("<div>14:00-14:30</div><div class='picPaName'>" + paName + "</div>");
					} else if(rsvtTime=='10') {
						$('#timePic10').removeClass("abled");
						$('#timePic10').css('background-color','#FFECEC');
						$('#timePic10').html("");
						$('#timePic10').append("<div>14:30-15:00</div><div class='picPaName'>" + paName + "</div>");
					} else if(rsvtTime=='11') {
						$('#timePic11').removeClass("abled");
						$('#timePic11').css('background-color','#FFECEC');
						$('#timePic11').html("");
						$('#timePic11').append("<div>15:00-15:30</div><div class='picPaName'>" + paName + "</div>");
					} else if(rsvtTime=='12') {
						$('#timePic12').removeClass("abled");
						$('#timePic12').css('background-color','#FFECEC');
						$('#timePic12').html("");
						$('#timePic12').append("<div>15:30-16:00</div><div class='picPaName'>" + paName + "</div>");
					} else if(rsvtTime=='13') {
						$('#timePic13').removeClass("abled");
						$('#timePic13').css('background-color','#FFECEC');
						$('#timePic13').html("");
						$('#timePic13').append("<div>16:00-16:30</div><div class='picPaName'>" + paName + "</div>");
					} else if(rsvtTime=='14') {
						$('#timePic14').removeClass("abled");
						$('#timePic14').css('background-color','#FFECEC');
						$('#timePic14').html("");
						$('#timePic14').append("<div>16:30-17:00</div><div class='picPaName'>" + paName + "</div>");
					} else if(rsvtTime=='15') {
						$('#timePic15').removeClass("abled");
						$('#timePic15').css('background-color','#FFECEC');
						$('#timePic15').html("");
						$('#timePic15').append("<div>17:00-17:30</div><div class='picPaName'>" + paName + "</div>");
					} else if(rsvtTime=='16') {
						$('#timePic16').removeClass("abled");
						$('#timePic16').css('background-color','#FFECEC');
						$('#timePic16').html("");
						$('#timePic16').append("<div>17:30-18:00</div><div class='picPaName'>" + paName + "</div>");
					}
	...
	$('#reservBtnAreaBtn').html("");
	$('#reservrsvtReason').val('');
	$('#reservRsvtDt').attr('value','');
	$('#reservEmpNo').attr('value','');
	$('#reservPaNo').attr('value','');
	$('#reservRsvtTime').attr('value','');
...
function getReservationList(rsvtDt) {
	...
	$.ajax({
		...
		success: function(rst){
			...
			$('.timePic').html("예약가능");
			$('.timePic').addClass("abled");
			$('.timePic').css('background-color','#DBF2F4');
			$.each(rst, function(idx){
				console.log(rst[idx].rsvtTime);
				if(rst[idx].rsvtTime=='1') {
					$('#timePic1').removeClass("abled");
...
function highlightAvailableTimes(dbStartTime, dbEndTime) {
  ...
  timeDivs.forEach((timePic, index) => {
    ...
    if (index !== firstInRangeIndex && index !== lastInRangeIndex) {
      ...
      // 데이터베이스 시작 시간과 종료 시간과 비교하여 배경 색상을 변경
      if (isTimeInRange(startTime, endTime, dbStartTime, dbEndTime)) {
        timePic.style.backgroundColor = '#E0E6E9';
        timePic.innerHTML = '예약불가';
        timePic.classList.remove('abled');
        
     // 클릭 이벤트 리스너 추가
        timePic.addEventListener('click', () => {
          // 클릭한 timePic에 대한 동작 수행
          console.log('timePic clicked:', timePic);
          // 원하는 동작을 여기에 추가
        });
      }
    }
